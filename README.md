...
=================
This repo contains code for procedurally creating sounds for your game. The example I am using is a synthized piano. You can read an indepth post here: [Realtime Procedural Audio and Synthesized Piano in Unity 3D](https://medium.com/@shahriyarshahrabi/realtime-procedural-audio-and-synthesized-piano-in-unity-3d-a98496a6df5e)
...
You can also play some notes on the key board your self. Which keys are mapped is listed in the Pianist class. 
